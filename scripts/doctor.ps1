...
$pythonWorkflowExamplesHelper = Join-Path $InstallRoot "integrations\python\revit_mcp_next_workflow_examples.py"
...
$pyRevitWorkflowExamplesCommand = Join-Path $InstallRoot "integrations\pyrevit\revit_mcp_next.extension\Revit MCP Next.tab\Examples.panel\Workflow Samples.pushbutton\script.py"
...
$dynamoWorkflowExamplesNode = Join-Path $InstallRoot "integrations\dynamo\workflow_examples_node.py"
...
Test-RequiredFile $pythonWorkflowExamplesHelper "Python workflow examples helper" | Out-Null
...
Test-RequiredFile $pyRevitWorkflowExamplesCommand "pyRevit workflow examples command" | Out-Null
...
Test-RequiredFile $dynamoWorkflowExamplesNode "Dynamo workflow examples node" | Out-Null
