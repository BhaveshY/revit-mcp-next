...
$inventoryTargets.Add((Join-Path $InstallRoot "revitctl.cmd")) | Out-Null
...
$inventoryTargets.Add((Join-Path $InstallRoot "integrations\python\revit_mcp_next_workflow_examples.py")) | Out-Null
...
$inventoryTargets.Add((Join-Path $InstallRoot "integrations\pyrevit\revit_mcp_next.extension\Revit MCP Next.tab\Examples.panel\Workflow Samples.pushbutton\script.py")) | Out-Null
...
$inventoryTargets.Add((Join-Path $InstallRoot "integrations\dynamo\workflow_examples_node.py")) | Out-Null
foreach ($year in $RevitYears) {
