...
try {
    ...
    foreach ($expectedTool in @("revit.get_views", "revit.get_sheets", "revit.describe_parameters", "revit.get_model_readiness", "revit.get_warnings", "revit.catalog", "revit.preview_change_set", "revit.apply_change_set", "revit.cancel_request")) {
