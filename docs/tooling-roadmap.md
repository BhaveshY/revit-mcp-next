...
| Schedules | Schedule inventory, schedulable field discovery, creation, field insertion, and sheet placement | Add-in/contracts | Reads first; preview/apply validates category, fields, duplicates, and sheet placement before mutation | Fake bridge/MCP tests plus live read smoke | available |
