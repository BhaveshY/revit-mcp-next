...
- `revit.catalog` provides compact, paginated discovery for element types, family symbols, title blocks, view family types, text note types, dimension types, and tag types, including Revit-compatible type IDs for a target element.
